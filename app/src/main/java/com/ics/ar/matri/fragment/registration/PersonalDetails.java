...
import com.ics.ar.matri.view.InputOpenFieldView;
...
public class PersonalDetails extends Fragment implements View.OnClickListener {
    ...
    public CustomEditText etDOB, etHeight, etState, etDistrict, etCity, etPincode,ask_Age;
    ...
    public void setUiAction(View view) {
      ...
      //  ask_Age = view.findViewById(R.id.ask_Age);
      ...
      //  ask_Age.setOnClickListener(this);
