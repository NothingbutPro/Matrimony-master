package com.ics.ar.matri.activity.dashboard;
...
import com.ics.ar.matri.fragment.Chats;
import com.ics.ar.matri.fragment.EventsFrag;
import com.ics.ar.matri.fragment.HomeFrag;
import com.ics.ar.matri.fragment.InterestFrag;
import com.ics.ar.matri.fragment.SearchFrag;
import com.ics.ar.matri.fragment.AboutFrag;
import com.ics.ar.matri.fragment.SettingsFrag;
import com.ics.ar.matri.fragment.ShortlistedFrag;
import com.ics.ar.matri.fragment.VisitorsFrag;
...
import com.ics.ar.matri.service.ServiceUtils;
import com.ics.ar.matri.sharedprefrence.SharedPrefrence;
import com.ics.ar.matri.utils.CustomTypeFaceSpan;
...
import com.ics.ar.matri.view.FontCache;
...
public class Dashboard extends AppCompatActivity {
        ...
        tvSubscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (prefrence.getBooleanValue(Consts.IS_SUBSCRIBE)) {
                    ...
                    Intent to_membership = new Intent(Dashboard.this , MemberShipActivity.class);
                    to_membership.putExtra("is_already" , true);
                    startActivity(to_membership);
                    overridePendingTransition(R.anim.anim_slide_in_left,
                            R.anim.anim_slide_out_left);
                    drawer.closeDrawers();
                } else {
    ...
    protected void onResume() {
       ...
       // parmsSubs.put(Consts.USER_ID, loginDTO.getData().getId());
        ...
        Log.e("name is",""+loginDTO.getData().getName());
        String s = loginDTO.getData().getName();
        Glide.with(mContext).
