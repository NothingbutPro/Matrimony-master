...
//        Log.e("age is",""+"Age is"+ProjectUtils.getAge(personalDetails.dob_timeStamp.getYear() , personalDetails.dob_timeStamp.getMonth() , personalDetails.dob_timeStamp.getDay()));
//        Toast.makeText(getActivity(), "age is"+"Age is"+ProjectUtils.getAge(personalDetails.dob_timeStamp.getYear() , personalDetails.dob_timeStamp.getMonth() , personalDetails.dob_timeStamp.getDay()), Toast.LENGTH_SHORT).show();
