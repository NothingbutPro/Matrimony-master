package com.ics.ar.matri.multipleimagepicker.adapters;
        ...
        switch (holder.getItemViewType()) {
            ...
            case TYPE_NORMAL:
                ...
                if (image != null) {
                    ...
                    if (imageFile.exists()) {
                        Glide.with(mContext).load(imageFile).placeholder(R.drawable.default_error).into(viewHolder2.getImage());
                    } else {
