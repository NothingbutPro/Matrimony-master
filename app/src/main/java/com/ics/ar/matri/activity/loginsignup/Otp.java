...
//import com.ics.ar.matri.interfaces.SmsListener;
//import com.ics.ar.matri.utils.SmsReceiver;
...
public class Otp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String coming_id = getIntent().getStringExtra("uses");
        loginDTO = prefrence.getLoginResponse(Consts.LOGIN_DTO);
//        parms_active.put(Consts.USER_ID, loginDTO.getData().getId());
        parms_active.put(Consts.USER_ID, coming_id);
