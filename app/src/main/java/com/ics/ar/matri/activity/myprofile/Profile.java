package com.ics.ar.matri.activity.myprofile;
...
import com.ics.ar.matri.activity.editprofile.CriticalFields;
import com.ics.ar.matri.activity.editprofile.ImportantDetailsActivity;
import com.ics.ar.matri.activity.editprofile.LifeStyleActivity;
import com.ics.ar.matri.activity.imageselection.ImageshowActivity;
import com.ics.ar.matri.activity.imageselection.MainActivity;
...
//        tvBirthCity = findViewById(R.id.tvBirthCity);
    ...
    public void showData() {
       // tvName.setText(userDTO.getName());
        tvName.setText("Arsh-"+userDTO.getId());
    ...
    public void getMyProfile() {
        ...
        new HttpsRequest(Consts.MY_PROFILE_API, getparmProfile(), mContext).stringPost(TAG, new Helper() {
            ...
            public void backResponse(boolean flag, String msg, JSONObject response) {
                if (flag) {
                    try {
                        Log.e("back response","profile"+response);
