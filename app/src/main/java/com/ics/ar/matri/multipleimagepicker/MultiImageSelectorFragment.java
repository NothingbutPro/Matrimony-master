package com.ics.ar.matri.multipleimagepicker;
...
import com.ics.ar.matri.multipleimagepicker.listeners.ImageOnItemClickListener;
import com.ics.ar.matri.multipleimagepicker.models.Folder;
import com.ics.ar.matri.multipleimagepicker.models.Image;
import com.ics.ar.matri.multipleimagepicker.utils.FileUtils;
import com.ics.ar.matri.multipleimagepicker.utils.ScreenUtils;
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        // imgPathUri = FileProvider.getUriForFile(getActivity().getApplicationContext(), "com.arshmuslim.matrimony", mTmpFile);
