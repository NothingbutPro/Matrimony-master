package com.ics.ar.matri.Models;
...
public class UserDTO implements Serializable {
    ...
    public String getGotra_nanihal() {
        return gotra_nanihal;
    }

    public void setGotra_nanihal(String gotra_nanihal) {
        this.gotra_nanihal = gotra_nanihal;
    }
    ...
    public String getFamily_district() {
        return family_district;
    }

    public void setFamily_district(String family_district) {
    ...
    public String getMaternal_grand_father_name_address() {
        return maternal_grand_father_name_address;
    }

    public void setMaternal_grand_father_name_address(String maternal_grand_father_name_address) {
        this.maternal_grand_father_name_address = maternal_grand_father_name_address;
    }
    ...
    public void setFamily_value(String family_value) {
